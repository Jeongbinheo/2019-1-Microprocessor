...
> ## Introduction
- 2019-1학기 ELEC323 마이크로프로세서 수업에서 배운 Mini CPU(이하 tPU)를 C++ 언어를 이용해 구현한 코드들에 대한 설명입니다.
...
>> ### **CMemory**
 ...
 - **256개의 index를 갖는 배열로 크기를 정하고 있고, Register와 비슷하게 write, read, show 함수를 가지고 있다.**
    
   ####  `>>  Let's see the Code`  
   #### [CMemory.cpp](https://github.com/Jeongbinheo/2019-1-Microprocessor/blob/master/CMemory.cpp) (클릭 시 전체 코드 페이지로 이동)
   #### [CMemory.h](https://github.com/Jeongbinheo/2019-1-Microprocessor/blob/master/CMemory.h) (클릭 시 전체 코드 페이지로 이동)
